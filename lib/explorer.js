...
var addDate = function (folder, stats) { // Add folder creation date (read or create hidden file)
    var date
...
var addSearch = function (folder) { // Add search as beautified basename
...
var addQuality = function (folder) { // Add movie's quality e.g. [1080p]
...
var addTags = function (folder) { // Add tags as e.g. {{tag1}} {{tag2}} {{tag3}}
