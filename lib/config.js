...
let config = { // Relative directories are based on the main process (bot.js)
    locations: {
        posters: './data/posters/full', // WARNING: THIS DIRECTORY IS REMOVED EACH PROCESS | You must create the directory prior to run the bot
        ...
        trailers: './data/trailers', // WARNING: THIS DIRECTORY IS REMOVED EACH PROCESS | You must create the directory prior to run the bot
