...
const duckduckgo = (search, lang) => { // Get DuckDuckGo results from keywords
    ...
    try {
        response = request('GET', encodeURI(`https://duckduckgo.com/html/?q=${search}&kl=${lang}`, {headers: {'user-agent': randomUa.generate()}})) // Send http request with a random user-agent so as to bypass restriction
    } catch (e) {
